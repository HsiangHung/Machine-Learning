...
For multiclass, $c = {1, ...K}$, $K$ classes. If our target is a **one-hot** vector, $p = [1, 0, ... 0]$ for $y = 1$, $p = [0, 2, ... 0]$, for $y = 2$, .... and $p = [0, 0, ... 1]$ for $y = K$, we arrive at the multiclassification cost function for a data instance $x$:
...
where $\mathbb{I} = 1$ for $y = c$; otherwise $\mathbb{I}=0$. 
...
| fish 🐟 | 0.667 (2/3)| 0.20 (2/10) | 0.308 (2x0.667x0.2/(0.667+0.2)) | 
| hen 🐔 | 0.667 (6/9) | 0.667 (6/9) | 0.667 (2x0.667x0.0.667/(0.667+0.667)) | 
...
|  |  precision |  recall | F1 score |
| --- | --- | --- | --- |
| Macro | 0.547 ((0.31+0.67+0.67)/3)| 0.511 ((0.667+0.2+0.667)/3) | 0.465 ((0.421+0.308+0.667)/3)| 
| Micro | 0.48 ((4+2+6)/(13+3+9)) | 0.48 ((4+2+6)/(6+10+9)) | 0.48 ((4+2+6)/(4+2+6+0.5(9+1+3+2+8+3))) | 
| Weighted | 0.58 ((0.31*6+0.67*10+0.67*9)/(6+10+9)) | | |
...
* [Multi-Class Metrics Made Simple, Part II: the F1-score]: https://shmueli.medium.com/multi-class-metrics-made-simple-part-ii-the-f1-score-ebe8b2c2ca1
[[Boaz Shmueli-2] Multi-Class Metrics Made Simple, Part II: the F1-score](https://shmueli.medium.com/multi-class-metrics-made-simple-part-ii-the-f1-score-ebe8b2c2ca1)
